...
export const getReviewHistory = (page: number = 1, size: number = 10, content: string = '', food: string = '', merchant: string = '', status: number|null = null): Promise<Response> => get(`${BASE_URL}/review`, { page, size, content, food, merchant, status })
